...
CREATE TABLE IF NOT EXISTS VET (
	VET_ID INT(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS OWNER (
	OWNER_ID INT(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
	F_NAME VARCHAR(30) NOT NULL,
	L_NAME VARCHAR(30) NOT NULL,
	ADDRESS VARCHAR(40),
	PHONE VARCHAR(15),
...
CREATE TABLE IF NOT EXISTS PET (
	PET_ID INT(7) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
	OWNER_ID INT,
...
CREATE TABLE IF NOT EXISTS MEDICINE (
	MEDICINE_ID INT(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
